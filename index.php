    ...
    <div class="swiper-container thm-swiper__slider" data-swiper-options='{
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="image-layer" style="background-image: url(<?= $config->site->url ?>/assets/images/familyhero.jpg);">
                </div>
            ...
            <div class="swiper-slide">
                <div class="image-layer" style="background-image: url(<?= $config->site->url ?>/assets/images/educationhero.png);">
                </div>
                <div class="image-layer-overlay"></div>
                <!-- /.image-layer -->
                <div class="container">
            ...
            <div class="swiper-slide">
                <div class="image-layer" style="background-image: url(<?= $config->site->url ?>/assets/images/communityhero.png);">
                </div>
                <div class="image-layer-overlay"></div>
                <!-- /.image-layer -->
                <div class="container">
            ...
            <div class="col-xl-12">
                <div class="become-volunteer__inner">
                    ...
                    <div class="become-volunteer__btn-box">
                        <a href="<?= $config->site->url ?>/become-volunteer/" class="become-volunteer__btn thm-btn"><i class="fas fa-arrow-circle-right"></i>Learn More</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-4">
                ...
                <div class="three-boxes__single">
                    <div class="three-boxes__single-bg" style="background-image: url(<?= $config->site->url ?>/assets/images/ThreeHealth.png)""></div>
            ...
            <div class="col-xl-4">
                ...
                <div class="three-boxes__single three-boxes__single-item-two">
                    <div class="three-boxes__single-bg" style="background-image: url(<?= $config->site->url ?>/assets/images/Threeeducation.png)"></div>
                    <div class="three-boxes__content">
                        <div class="three-boxes__icon">
            ...
            <div class="col-xl-4">
                ...
                <div class="three-boxes__single three-boxes__single-item-three">
                    <div class="three-boxes__single-bg" style="background-image: url(<?= $config->site->url ?>/assets/images/resources/three-boxes-img-1.jpg)"></div>
                    <div class="three-boxes__content">
                        <div class="three-boxes__icon">
...
<section class="testimonial-one">
    <div class="testimonial-one-bg" style="background-image: url(<?= $config->site->url ?>/assets/images/intro.png)"></div>
    <div class="container">
        <div class="row">
            <div class="col-xl-4">
...
<section class="help-them">
    <div class="help-them-bg jarallax" data-jarallax data-speed="0.2" data-imgPosition="50% 0%" style="background-image: url(<?= $config->site->url ?>/assets/images/familyhero.png)"></div>
    <div class="container">
